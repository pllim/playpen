...
def pick_tribute(population, previous_tribute, seed=None):
...
def test_pick_tribute():
    ...
    # then Jon/Theon. The rest is fair game.
    previous_tribute = ['Robb Stark', 'Jon Snow', 'Robb Stark',
                        'Arya Stark', 'Theon Greyjoy', 'Arya Stark',
                        'Arya Stark', 'Dolores']
    assert pick_tribute(population, previous_tribute, seed=1234) == 'Sansa Stark'  # noqa
    assert pick_tribute(population, previous_tribute, seed=4321) == 'Bran Stark'  # noqa
